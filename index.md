...
|||
[2](Week_02.html) | Mon, Jan 10 | [![PDHS Image](images/PDSH-cover-small.png) Ch 1 of PDSH: introduction to NumPy](https://jakevdp.github.io/PythonDataScienceHandbook/01.00-ipython-beyond-normal-python.html) | [Introduction to Jupyter](jupyter_intro.md) and the notebook [Introduction to Jupyter](https://github.com/AIBiology/Jupyter_Content/blob/main/Intro_to_Jupyter.ipynb)
